...
If you really want me to add more features to this, I can. Just dm me on Discord at @nooooow_
<h2>FAQ</h2>
- Intents error: install discord.py-self<br>
- Any other errors, make sure you have discord.py installed or if theres anything else that you cant fix dm @nooooow_ on discord. 
